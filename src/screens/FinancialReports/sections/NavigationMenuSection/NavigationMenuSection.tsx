...
export const NavigationMenuSection = (): JSX.Element => {
  const [activeItem, setActiveItem] = useState("financial-reports");
  ...
  const renderMenuItem = (item: MenuItem, isSubItem = false) => {
    ...
    const hasBackground = item.hasBackground || isActive;

    return (
      <div
        key={item.id}
        className={`flex flex-col justify-center pt-[var(--corner-radius-extra-small)] ${
          isSubItem
            ? "pr-[var(--corner-radius-extra-large)]"
            : "pr-[var(--corner-radius-extra-small)]"
        } pb-[var(--corner-radius-extra-small)] pl-[var(--corner-radius-extra-small)] self-stretch w-full flex-[0_0_auto] rounded-[var(--corner-radius-medium)] items-center gap-2.5 relative cursor-pointer hover:bg-color-mode-surface-purple-bg transition-colors`}
      ...
      >
        <div
          className={`flex flex-col h-[41px] items-start justify-center gap-2.5 pt-[var(--corner-radius-medium)] pr-[var(--corner-radius-small)] pb-[var(--corner-radius-medium)] pl-[var(--corner-radius-small)] relative self-stretch w-full rounded-[var(--corner-radius-medium)] ${
            hasBackground ? "bg-color-mode-surface-purple-bg" : ""
          } ${isActive && !hasBackground ? "bg-color-mode-surface-bg-icon-gray" : ""}`}
        >
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-end gap-10 relative self-stretch w-full flex-[0_0_auto]">
        ...
        <div className="flex flex-col items-end gap-[11px] relative self-stretch w-full flex-[0_0_auto]">
          ...
          <div className="flex flex-col items-end gap-2.5 pt-[var(--dimensions-size-medium)] pb-[var(--dimensions-size-medium)] px-2.5 relative self-stretch w-full flex-[0_0_auto] rounded-[var(--dimensions-size-medium)]">
            <button
              className="flex items-center justify-end gap-[var(--dimensions-size-small)] relative self-stretch w-full flex-[0_0_auto] cursor-pointer hover:opacity-80 transition-opacity"
      ...
      <div className="inline-flex items-center gap-3 px-2.5 py-0 relative flex-[0_0_auto] ml-[-12.00px]">
