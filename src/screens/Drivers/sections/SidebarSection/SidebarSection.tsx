...
export const SidebarSection = (): JSX.Element => {
  ...
  const resourcesSection: MenuSection = {
  ...
  const reportsSection: MenuSection = {
  ...
  const renderMenuItem = (item: MenuItem, isSubItem = false) => (
    <div
      key={item.id}
      className={`flex flex-col items-center justify-center gap-2.5 pt-[var(--corner-radius-extra-small)] pr-${isSubItem ? "[var(--corner-radius-extra-large)]" : "[var(--corner-radius-extra-small)]"} pb-[var(--corner-radius-extra-small)] pl-[var(--corner-radius-extra-small)] relative self-stretch w-full flex-[0_0_auto] rounded-[var(--corner-radius-medium)] ${item.hasBackground ? "bg-color-mode-surface-purple-bg" : ""} cursor-pointer hover:bg-color-mode-surface-purple-bg transition-colors`}
      ...
      <div className="flex flex-col h-[41px] items-start justify-center gap-2.5 pt-[var(--corner-radius-medium)] pr-[var(--corner-radius-small)] pb-[var(--corner-radius-medium)] pl-[var(--corner-radius-small)] relative self-stretch w-full rounded-[var(--corner-radius-medium)]">
        <div className="mt-[-0.50px] mb-[-0.50px] flex items-center gap-[var(--dimensions-size-small)] relative self-stretch w-full flex-[0_0_auto]">
          <div className="flex h-[17px] justify-end pl-2.5 pr-0 py-2.5 flex-1 grow items-center gap-2.5 relative">
            <div className="relative flex-1 h-5 mt-[-12.50px] mb-[-10.50px] font-[number:var(--fine-print-small-medium-underline-font-weight)] text-color-mode-text-icons-t-primary-gray text-[length:var(--fine-print-small-medium-underline-font-size)] tracking-[var(--fine-print-small-medium-underline-letter-spacing)] leading-[var(--fine-print-small-medium-underline-line-height)] underline [direction:rtl] font-fine-print-small-medium-underline whitespace-nowrap [font-style:var(--fine-print-small-medium-underline-font-style)]">
              {item.label}
            </div>
          </div>
      ...
      {section.title && (
        <div className="flex flex-col items-start gap-2.5 p-2.5 relative self-stretch w-full flex-[0_0_auto]">
          <div className="flex items-center justify-center gap-[var(--dimensions-size-small)] relative self-stretch w-full flex-[0_0_auto]">
            ...
            <div className="relative w-fit mt-[-1.00px] opacity-60 font-[number:var(--headings-h1-h6-heading-6-font-weight)] text-color-mode-text-icons-t-placeholder text-[length:var(--headings-h1-h6-heading-6-font-size)] tracking-[var(--headings-h1-h6-heading-6-letter-spacing)] leading-[var(--headings-h1-h6-heading-6-line-height)] [direction:rtl] font-headings-h1-h6-heading-6 whitespace-nowrap [font-style:var(--headings-h1-h6-heading-6-font-style)]">
              {section.title}
            </div>
          </div>
        </div>
  ...
  return (
    <aside
      className="flex flex-col w-[280px] h-[1455px] items-end gap-[var(--corner-radius-extra-large-6)] pt-[var(--dimensions-size-large)] pr-[var(--dimensions-size-large)] pb-[var(--corner-radius-full)] pl-[var(--dimensions-size-medium)] absolute top-0 right-0 bg-color-mode-surface-bg-screen border-l-[0.3px] [border-left-style:solid] border-color-mode-text-icons-t-placeholder"
    ...
    >
      ...
      <div className="flex flex-col items-end gap-10 relative self-stretch w-full flex-[0_0_auto]">
        ...
        >
          ...
          {renderMenuSection(resourcesSection)}

          {renderMenuSection(reportsSection)}
          ...
          <div className="flex flex-col items-end gap-2.5 pt-[var(--dimensions-size-medium)] pb-[var(--dimensions-size-medium)] px-2.5 relative self-stretch w-full flex-[0_0_auto] rounded-[var(--dimensions-size-medium)]">
            <button
              className="justify-end flex items-center gap-[var(--dimensions-size-small)] relative self-stretch w-full flex-[0_0_auto] cursor-pointer hover:opacity-80 transition-opacity"
              onClick={() => console.log("Logout clicked")}
              aria-label="تسجيل الخروج"
            >
              <div className="flex h-[17px] justify-end pl-2.5 pr-0 py-2.5 flex-1 grow items-center gap-2.5 relative">
                <div className="flex-1 h-5 mt-[-12.50px] mb-[-10.50px] font-[number:var(--fine-print-small-medium-underline-font-weight)] text-color-mode-text-icons-t-red text-[length:var(--fine-print-small-medium-underline-font-size)] tracking-[var(--fine-print-small-medium-underline-letter-spacing)] leading-[var(--fine-print-small-medium-underline-line-height)] underline relative font-fine-print-small-medium-underline whitespace-nowrap [direction:rtl] [font-style:var(--fine-print-small-medium-underline-font-style)]">
                  تسجيل الخروج
                </div>
              </div>
      ...
      <footer className="inline-flex items-center gap-3 px-2.5 py-0 relative flex-[0_0_auto] ml-[-12.00px]">
        <div className="flex flex-col w-[184px] h-[35px] items-start gap-[3px] relative">
          <div className="relative self-stretch h-[18px] mt-[-1.00px] font-[number:var(--subtitle-subtitle-3-font-weight)] text-color-mode-text-icons-t-primary-gray text-[length:var(--subtitle-subtitle-3-font-size)] tracking-[var(--subtitle-subtitle-3-letter-spacing)] leading-[var(--subtitle-subtitle-3-line-height)] [direction:rtl] font-subtitle-subtitle-3 whitespace-nowrap [font-style:var(--subtitle-subtitle-3-font-style)]">
        ...
        <img
          className="relative w-10 h-[23.2px] aspect-[1] object-cover"
