...
export const Navigation: React.FC<NavigationProps> = ({
  ...
  return (
    <nav
      className={`flex flex-col w-[280px] h-[1423px] items-end gap-[var(--corner-radius-extra-large-6)] 
             pt-[var(--dimensions-size-large)] pr-[var(--dimensions-size-large)] 
             pb-[var(--corner-radius-full)] pl-[var(--dimensions-size-medium)] 
             absolute top-0 left-[1160px] bg-white text-black border-l border-gray-200 ${className}`}
      role="navigation"
